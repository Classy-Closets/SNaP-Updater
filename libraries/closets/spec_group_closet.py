...
COUNTERTOP_STANDARD_QUARTZ_MATERIAL = ("Countertop Materials", "Annica")
COUNTERTOP_BUTCHER_BLOCK_MATERIAL = ("Closet Materials", "Craft Oak")
COUNTERTOP_WOOD_STAIN_MATERIAL = ("Closet Materials", "Craft Oak")
CORE = ("Wood Core", "PB")
...
class Material_Pointers():
    ...
    Cabinet_Countertop_Surface = sn_types.Material_Pointer(COUNTERTOP_MATERIAL)
    Countertop_Surface = sn_types.Material_Pointer(COUNTERTOP_MATERIAL)
    Countertop_HPL_Surface = sn_types.Material_Pointer(COUNTERTOP_HPL_MATERIAL)
    Countertop_Granite_Surface = sn_types.Material_Pointer(COUNTERTOP_GRANITE_MATERIAL)
    Countertop_Quartz_Surface = sn_types.Material_Pointer(COUNTERTOP_QUARTZ_MATERIAL)
    Countertop_Butcher_Block_Surface = sn_types.Material_Pointer(COUNTERTOP_BUTCHER_BLOCK_MATERIAL)
    Countertop_Wood_Stained_Surface = sn_types.Material_Pointer(COUNTERTOP_WOOD_STAIN_MATERIAL)
