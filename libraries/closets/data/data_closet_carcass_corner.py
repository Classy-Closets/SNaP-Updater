...
class L_Shelves(sn_types.Assembly):
    ...
    def pre_draw(self):
        ...
        bottom.loc_z('IF(Is_Hanging,Height-Panel_Height,Toe_Kick_Height)', [Is_Hanging, Height, Panel_Height, Toe_Kick_Height, Shelf_Thickness])
        ...
        bottom.rot_x(value=math.radians(0))
        bottom.rot_z(value=math.radians(0))
...
class Corner_Shelves(sn_types.Assembly):
    ...
    def draw(self):
        ...
        bottom_angled.loc_z('IF(Is_Hanging,Height-Panel_Height,Toe_Kick_Height)', [Is_Hanging, Height, Panel_Height, Toe_Kick_Height, Shelf_Thickness])
        ...
        bottom_angled.rot_x(value=math.radians(0))
        bottom_angled.rot_z(value=math.radians(0))
