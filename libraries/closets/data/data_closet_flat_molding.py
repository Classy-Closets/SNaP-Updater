...
class Flat_Crown(Flat_Molding):
    ...
    def draw(self):
        ...
        left_return.set_name("Left")
        left_return.loc_x('(-Panel_Thickness)-Extend_Left_Amount', [Panel_Thickness, Extend_Left_Amount, Show_Layered, Molding_Height])
        left_return.loc_y(
        ...
        left_return.rot_x(expression='IF(Show_Layered,radians(-180),radians(90))', variables=[Show_Layered])
        left_return.rot_z(value=math.radians(90))
        left_return.dim_x(
            'Depth+Front_Overhang+Panel_Thickness-' + str(sn_unit.millimeter(0.1)) + '',
        ...
        right_return.set_name("Right")
        right_return.loc_x('Width+Extend_Right_Amount-IF(Show_Layered,-INCH(0.75),0)', [Width, Extend_Right_Amount,Show_Layered,Molding_Height])
        right_return.loc_y(
            '-Depth-Front_Overhang-Panel_Thickness+' + str(sn_unit.millimeter(0.1)) + '',
            [Depth, Front_Overhang, Panel_Thickness])
        right_return.loc_z('IF(Show_Layered,IF(Topshelf_Exists,INCH(0.75),0),IF(ETC,DFC,Molding_Height+Molding_Location))', [Molding_Height, Molding_Location, ETC, DFC, Show_Layered, Topshelf_Exists])
        right_return.rot_x(expression='IF(Show_Layered,0,radians(90))', variables=[Show_Layered])
        right_return.rot_z(value=math.radians(90))
        right_return.dim_x(
            'Depth+Front_Overhang+Panel_Thickness-' + str(sn_unit.millimeter(0.1)) + '',
            [Depth, Panel_Thickness, Front_Overhang])
        ...
        left_return.obj_bp.snap.comment_2 = "1038"
        left_return.set_name("Left")
        left_return.loc_x('(-Panel_Thickness)-Extend_Left_Amount+IF(Show_Layered,-INCH(0.75),0)', [Panel_Thickness, Extend_Left_Amount, Show_Layered, Molding_Height])
        left_return.loc_y(
            '-Depth-Front_Overhang-Panel_Thickness+' + str(sn_unit.millimeter(0.1)) + '-INCH(0.75)',
            [Depth, Front_Overhang, Panel_Thickness])
        left_return.loc_z('IF(Show_Layered,IF(Topshelf_Exists,INCH(2.25),INCH(1.5)),IF(ETC,DFC,Molding_Height+Molding_Location))', [Molding_Height, Molding_Location, ETC, DFC, Show_Layered, Topshelf_Exists])
        left_return.rot_x(expression='IF(Show_Layered,radians(-180),radians(90))', variables=[Show_Layered])
        left_return.rot_z(value=math.radians(90))
        left_return.dim_x(
            'Depth+Front_Overhang+Panel_Thickness-' + str(sn_unit.millimeter(0.1)) + '+INCH(0.75)',
        ...
        right_return.obj_bp.snap.comment_2 = "1038"
        right_return.set_name("Right")
        right_return.loc_x('Width+Extend_Right_Amount-IF(Show_Layered,-INCH(1.5),0)', [Width, Extend_Right_Amount,Show_Layered,Molding_Height])
        right_return.loc_y(
            '-Depth-Front_Overhang-Panel_Thickness+' + str(sn_unit.millimeter(0.1)) + '-INCH(0.75)',
            [Depth, Front_Overhang, Panel_Thickness])
        right_return.loc_z('IF(Show_Layered,IF(Topshelf_Exists,INCH(1.5),INCH(0.75)),IF(ETC,DFC,Molding_Height+Molding_Location))', [Molding_Height, Molding_Location, ETC, DFC, Show_Layered, Panel_Thickness, Topshelf_Exists])
        right_return.rot_x(expression='IF(Show_Layered,0,radians(90))', variables=[Show_Layered])
        right_return.rot_z(value=math.radians(90))
        right_return.dim_x(
            'Depth+Front_Overhang+Panel_Thickness-' + str(sn_unit.millimeter(0.1)) + '+INCH(0.75)',
