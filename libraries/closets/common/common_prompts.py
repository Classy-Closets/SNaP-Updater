...
def add_countertop_prompts(assembly):
    ...
    assembly.add_prompt("HPL Edge Type", 'COMBOBOX', 0, ['Ora', 'Futura', 'Nova', 'Tempo', 'Flat'])
    assembly.add_prompt("Stone Edge Type", 'COMBOBOX', 0, ['Miter', 'STD Eased', 'Bullnose', 'Demi Bullnose', 'Crescent', 'Bevel', 'Euro', 'Ogee', 'Ogee Bullnose', 'Double Bevel', 'Chisel', 'Miter 4"', 'Miter 6"', 'Miter Waterfall'])
    # assembly.add_prompt("Edge Type", 'COMBOBOX', 1, ['Waterfall', 'Flat Front', '180 Degree', 'Alder Miter'])
    assembly.add_prompt("Painted Edge Type", 'COMBOBOX', 0, ['Solid Flat', 'Solid Round', 'Solid Ogee', 'Applied Flat', 'Applied Round', 'Applied Ogee'])
    assembly.add_prompt("Stained Edge Type", 'COMBOBOX', 0, ['Dolce', 'Solid Flat Applied', 'Solid Round Applied', 'Solid Ogee Applied', 'Alder Miter'])
