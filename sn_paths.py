...
DEFAULT_KITCHEN_BATH_CABINET_TYPE = "PRE_BUILT"
...
CLOSET_MATERIAL_LEGACY_DIR = os.path.join(MATERIAL_DIR, "Closet Materials Legacy")
...
PAINT_COLORS_CSV_PATH = os.path.join(CSV_DIR_PATH, "PaintColors.csv")
STAIN_COLORS_CSV_PATH = os.path.join(CSV_DIR_PATH, "StainColors.csv")
...
MELAMINE_GLASS_COLORS_CSV_PATH = os.path.join(CSV_DIR_PATH, "MelamineGlassColors.csv")
GLASS_SHELF_COLORS_CSV_PATH = os.path.join(CSV_DIR_PATH, "GlassShelfColors.csv")
...
COLOR_CONVERSION_CSV_DIR = os.path.join(CSV_DIR_PATH, "ColorConversions240.csv")
